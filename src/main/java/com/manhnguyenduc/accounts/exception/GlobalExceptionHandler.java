package com.manhnguyenduc.accounts.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleResourceNotFoundExistException(ResourceNotFoundException exception, WebRequest webRequest) {
